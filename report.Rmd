...
As we can see, the RMSE for the model that trains/fits the entire data set is superior to that of the train/test (and superior to the simple linear regression model), but that may be due to overfitting.
