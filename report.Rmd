...
We see that well over 50% of the records have at least one numeric feature missing. This means that eliminating the records with missing data is not feasible. So the next step is to determine which value, per feature, makes the most sense as a substitute. Using the MEAN value of the feature makes sense if the data is relatively normal, while MEDIAN would work best for highly skewed data.  We produce histograms showing the distribution, mean and median for the numeric features to examine the normalcy:
