...
We will remove predictors from the data set that have more than 10% missing values
...
```{r}
train_data <- train_data %>% select(-health__homicides_per_100k,
                                   -health__pct_excessive_drinking,
                                  -health__pct_adult_smoking,
                      -health__motor_vehicle_crash_deaths_per_100k)
```
...
```{r}
train_data <- train_data[-c(1090, 1251), ]
```
